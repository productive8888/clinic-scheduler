  ...
  return (
    <ScheduleWeekBoard
      ...
      resultSummary={{
        ...
        patientRangeSwaps: stringParam(params.patientRangeSwaps),
        patientDiversitySwaps: stringParam(params.patientDiversitySwaps),
        patientRepairBlocked: stringParam(params.patientRepairBlocked),
        patientBelowMinimum: stringParam(params.patientBelowMinimum),
        patientAboveMaximum: stringParam(params.patientAboveMaximum),
